...
export const MERCHANT_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () => import('../../features/merchant/pages/product/product-discount-curpon/product-discount-curpon')
          .then(c => c.ProductDiscountCurpon)
      },
      {
        path: 'product/discountform',
        loadComponent: () => import('../merchant/pages/product/form-discount/form-discount')
          .then(c => c.FormDiscount)
      },
      {
        path: 'order',
        loadComponent: () =>
